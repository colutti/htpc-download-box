...
# Searcharr Bot
searcharr_password = "12345"  # Used to authenticate as a regular user to add series/movies
searcharr_admin_password = "let7hu118"  # Used to authenticate as admin to manage users
searcharr_language = "pt-br"  # yml file in the lang folder
...
# Telegram
tgram_token = "5676836532:AAHkrgDWF1bdWoTJ2-YfCuU5dsO_zDusdPU"

# Sonarr
sonarr_enabled = True
sonarr_url = "http://192.168.1.2:8989"  # http://192.168.0.100:8989
sonarr_api_key = "e06f2aed4456491fba63050f45dfd7dc"
...
# Radarr
radarr_enabled = True
radarr_url = "http://192.168.1.2:7878"  # http://192.168.0.100:7878
radarr_api_key = "70e5a6e3d5d145edabe01ae52e900e2f"
